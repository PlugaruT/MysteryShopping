...
from mystery_shopping.cxi.views_chart import CXIPerCompanyElement, IndicatorPerCompanyElement
...
urlpatterns = [
    ...
    url(r'^cxi/cxi-per-company-element/$', CXIPerCompanyElement.as_view(), name='cxi-per-company-element'),
